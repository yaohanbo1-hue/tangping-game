...
const DREAM_FRAGMENTS = [
  ...
  { id:'frag_23', title:'手环上的名字', desc:'和你的一模一样', icon:'⌚', rarity:'rare',
    text:'照片里那只手环的腕带上刻着名字。你把照片放大到发虚，才敢承认那三个字和你的一模一样。' },
  { id:'frag_24', title:'值夜表的背面', desc:'被写过又擦掉', icon:'📋', rarity:'rare',
  ...
  { id:'frag_26', title:'雨声里的另一层', desc:'多出来的那个呼吸', icon:'🌧️', rarity:'epic',
  ...
  { id:'frag_28', title:'第四格的名字', desc:'被雨水泡开的墨迹', icon:'🖋️', rarity:'epic',
    text:'值夜表的第四格被雨水泡过，墨迹散成一团。但在紫外灯下还能看出一个偏旁 —— 和你自己的姓，是同一个。' },
  { id:'frag_29', title:'录音的最后一秒', desc:'一直没有播完的那一段', icon:'▶️', rarity:'legendary',
    text:'进度条走到 06:59 就断了。你把缺的那零点几秒补上，听见有人轻轻把门带上，然后对着床铺说了一句："我们回来了。"' },
  { id:'frag_30', title:'醒来的第一句话', desc:'最后一块碎片', icon:'🌅', rarity:'legendary',
